...
##Tidy data by removing Fairbank and Endikai Lks b/c incomplete baselines
data <- data %>%
...
#binding together to create master data frame w/ all baseline C/Ns, mean prop. littoral
