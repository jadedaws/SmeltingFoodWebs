...
```{r Test plots: SMB + YP isoscapes w/ 40% ellipse across lakes}
...
```{r Creating master dataframe 'bigdat'}
...
###ANOVA
yp_pl_aov<-lm(adjprop_litt ~ Water, data = yp_adjPL)
anova(yp_pl_aov)
