...
test2 <- test2[,c(24,2:7,1,8:23,25:27)]

#stitching together to update 'bigdat'
bigdat <- rbind(test,test2)

bigdat[,25:27] <- sapply(bigdat[,25:27], as.numeric)
...
test2 <- test2[,c(25,2:7,1,8:24,26:28)]

#stitching together to update 'bigdat'
bigdat <- rbind(test,test2)

bigdat[,26:28] <- sapply(bigdat[,26:28], as.numeric)
