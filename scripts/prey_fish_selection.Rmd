...
ggplot(data = baby_pseed, aes(FLEN)) + 
  geom_histogram(breaks=seq(60, 120, by = 10), 
                 ...
                 fill="grey", 
                 alpha = .7) + 
  labs(title="Baby Lake Pumpkinseed Prey Fish Size", x="Fork Length (mm)", y="Count")
...
ggplot(data=baby_pseed_freq, aes(x=FLEN, y=freq))+
  ...
  xlab("Fork Length (mm)")+
  ylab("Frequency")+
  ggtitle("Baby Lake Pumpkinseed Size Prey Fish Distribution")+
  scale_y_continuous()+
  scale_x_continuous()+
  geom_text(aes(label=pctlbls), vjust=-0.5)+
  theme_bw()
...
ggplot(data = baby_perch, aes(FLEN)) + 
  geom_histogram(breaks=seq(50, 210, by = 10), 
                 ...
                 fill="grey", 
                 alpha = .7) + 
  labs(title="Baby Lake Yellow Perch Prey Fish Size", x="Fork Length (mm)", y="Count")
...
ggplot(data=baby_perch_freq, aes(x=FLEN, y=freq))+
  ...
  xlab("Fork Length (mm)")+
  ylab("Frequency")+
  ggtitle("Baby Lake Yellow Perch Prey Fish Size Distribution")+
  scale_y_continuous()+
  scale_x_continuous()+
  geom_text(aes(label=pctlbls), vjust=-0.5)+
  theme_bw()
...
ggplot(data = daisy_bbull, aes(FLEN)) + 
  geom_histogram(breaks=seq(80, 210, by = 10), 
                 ...
                 fill="grey", 
                 alpha = .7) + 
  labs(title="Daisy Lake Brown Bullhead Prey Fish Size", x="Fork Length (mm)", y="Count")
...
ggplot(data=daisy_bbull_freq, aes(x=FLEN, y=freq))+
  ...
  xlab("Fork Length (mm)")+
  ylab("Frequency")+
  ggtitle("Daisy Lake Brown Bullhead Prey Fish Size Distribution")+
  scale_y_continuous()+
  scale_x_continuous()+
  geom_text(aes(label=pctlbls), vjust=-0.5)+
  theme_bw()
...
ggplot(data = daisy_smb, aes(FLEN)) + 
  geom_histogram(breaks=seq(100, 210, by = 10), 
                 ...
                 fill="grey", 
                 alpha = .7) + 
  labs(title="Daisy Lake Smallmouth Bass Prey Fish Size", x="Fork Length (mm)", y="Count")
...
ggplot(data=daisy_smb_freq, aes(x=FLEN, y=freq))+
  ...
  xlab("Fork Length (mm)")+
  ylab("Frequency")+
  ggtitle("Daisy Lake Smallmouth Bass Prey Fish Size Distribution")+
  scale_y_continuous()+
  scale_x_continuous()+
  geom_text(aes(label=pctlbls), vjust=-0.5)+
  theme_bw()
...
ggplot(data = daisy_perch, aes(FLEN)) + 
  geom_histogram(breaks=seq(30, 180, by = 10), 
                 ...
                 fill="grey", 
                 alpha = .7) + 
  labs(title="Daisy Lake Yellow Perch Prey Fish Size", x="Fork Length (mm)", y="Count")
...
ggplot(data=daisy_perch_freq, aes(x=FLEN, y=freq))+
  ...
  xlab("Fork Length (mm)")+
  ylab("Frequency")+
  ggtitle("Daisy Lake Yellow Perch Prey Fish Size Distribution")+
  scale_y_continuous()+
  scale_x_continuous()+
  geom_text(aes(label=pctlbls), vjust=-0.5)+
  theme_bw()
